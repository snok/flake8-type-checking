"""
This file tests the TCHA001 error:
...
from flake8_typing_only_imports.constants import TCHA001
...
examples = [
    ...
    ('if TYPE_CHECKING:\n\tx = 2', set()),
    # Unused import
    ('if TYPE_CHECKING:\n\tfrom typing import Dict', {'1:0 ' + TCHA001}),
    ('if TYPE_CHECKING:\n\tfrom typing import Dict, Any', {'1:0 ' + TCHA001}),
    (f'if TYPE_CHECKING:\n\timport {mod}', {'1:0 ' + TCHA001}),
    (f'if TYPE_CHECKING:\n\tfrom {mod} import constants', {'1:0 ' + TCHA001}),
    # Used imports
    ...
    # Probably not much point in adding many more test cases, as the logic for TCHA001
...
def test_TCHA001_errors(example, expected):
    assert _get_error(example, error_code_filter='TCHA001') == expected
